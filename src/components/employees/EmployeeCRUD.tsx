...
const EmployeeCRUD: React.FC<{ companyId: string }> = ({ companyId }) => {
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom: 24, padding: 10, border: "1px solid #ccc" }}>
        ...
        <div>
          ...
          <input
            ...
            value={form.employment?.departmentId || ""}
            onChange={handleChange}
          />
        ...
        <div>
          ...
          <input
            name="employment.positionId"
            value={form.employment?.positionId || ""}
            onChange={handleChange}
          />
        ...
        <div>
          ...
          <input
            name="employment.locationId"
            value={form.employment?.locationId || ""}
            onChange={handleChange}
          />
        </div>
        <div>
          ...
          <input
            name="employment.dateHired"
            type="date"
            value={form.employment?.dateHired || ""}
            onChange={handleChange}
          />
